package proto.line {
	...
	public class m_personybc_public_toc extends Message
	{
		public var succ:Boolean = true;
		public var reason:String = "";
		public var info:p_personybc_info = null;
		public function m_personybc_public_toc() {
			super();
			this.info = new p_personybc_info;

			flash.net.registerClassAlias("copy.proto.line.m_personybc_public_toc", m_personybc_public_toc);
		}
		public override function getMethodName():String {
			return 'personybc_public';
		}
		...
		public override function readFromDataOutput(input:ByteArray):void {
			...
			if (byte_info_size > 0) {				this.info = new p_personybc_info;
