package proto.line {
	...
	public class m_letter_batch_send_tos extends Message
	{
		public var text:String = "";
		public var goods_list:Array = new Array;
		public var type:int = 0;
		public var days:int = 0;
		public var condition:p_letter_send_condition = null;
		public function m_letter_batch_send_tos() {
			super();
			this.condition = new p_letter_send_condition;

			flash.net.registerClassAlias("copy.proto.line.m_letter_batch_send_tos", m_letter_batch_send_tos);
		}
		public override function getMethodName():String {
			return 'letter_batch_send';
		}
		public override function writeToDataOutput(output:ByteArray):void {
			...
			var tmp_condition:ByteArray = new ByteArray;
			this.condition.writeToDataOutput(tmp_condition);
			var size_tmp_condition:int = tmp_condition.length;
			output.writeInt(size_tmp_condition);
			output.writeBytes(tmp_condition);
		}
		public override function readFromDataOutput(input:ByteArray):void {
			...
			var byte_condition_size:int = input.readInt();
			if (byte_condition_size > 0) {				this.condition = new p_letter_send_condition;
				var byte_condition:ByteArray = new ByteArray;
				input.readBytes(byte_condition, 0, byte_condition_size);
				this.condition.readFromDataOutput(byte_condition);
			}
		}
	}
}
