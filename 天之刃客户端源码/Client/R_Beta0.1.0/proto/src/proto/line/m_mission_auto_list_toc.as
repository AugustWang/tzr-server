package proto.line {
	import proto.line.p_mission_auto_data;
	import flash.net.registerClassAlias;
	import com.Message;
	import flash.utils.ByteArray;
	public class m_mission_auto_list_toc extends Message
	{
		public var succ:Boolean = true;
		public var reason:String = "";
		public var list:Array = new Array;
		public function m_mission_auto_list_toc() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_mission_auto_list_toc", m_mission_auto_list_toc);
		}
		...
		public override function writeToDataOutput(output:ByteArray):void {
			...
			for(i=0; i<size_list; i++) {
				...
				var tVo_list:p_mission_auto_data = this.list[i] as p_mission_auto_data;
		...
		public override function readFromDataOutput(input:ByteArray):void {
			...
			if (length_list > 0) {
				...
				for(i=0; i<size_list; i++) {
					var tmp_list:p_mission_auto_data = new p_mission_auto_data;
