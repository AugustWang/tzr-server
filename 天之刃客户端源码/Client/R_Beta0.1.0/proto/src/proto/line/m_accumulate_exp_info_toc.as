package proto.line {
	...
	public class m_accumulate_exp_info_toc extends Message
	{
		public var succ:Boolean = true;
		public var reason:String = "";
		public var info:p_accumulate_exp_info = null;
		public function m_accumulate_exp_info_toc() {
			super();
			this.info = new p_accumulate_exp_info;

			flash.net.registerClassAlias("copy.proto.line.m_accumulate_exp_info_toc", m_accumulate_exp_info_toc);
		}
		...
		public override function readFromDataOutput(input:ByteArray):void {
			...
			if (byte_info_size > 0) {				this.info = new p_accumulate_exp_info;
