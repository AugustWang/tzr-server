package proto.line {
	...
	public class m_fmldepot_putin_tos extends Message
	{
		public var bag_id:int = 0;
		public var goods_id:int = 0;
		public function m_fmldepot_putin_tos() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_fmldepot_putin_tos", m_fmldepot_putin_tos);
		}
