package proto.line {
	...
	public class m_pet_attr_assign_toc extends Message
	{
		public var succ:Boolean = true;
		public var reason:String = "";
		public var pet_info:p_pet = null;
		public function m_pet_attr_assign_toc() {
			super();
			this.pet_info = new p_pet;

			flash.net.registerClassAlias("copy.proto.line.m_pet_attr_assign_toc", m_pet_attr_assign_toc);
		}
