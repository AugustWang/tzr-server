package proto.line {
	...
	public class m_ranking_role_rece_flowers_last_week_rank_toc extends Message
	{
		public var role_rece_flowers:Array = new Array;
		public function m_ranking_role_rece_flowers_last_week_rank_toc() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_ranking_role_rece_flowers_last_week_rank_toc", m_ranking_role_rece_flowers_last_week_rank_toc);
		}
		public override function getMethodName():String {
			return 'ranking_role_rece_flowers_last_week_rank';
		}
		public override function writeToDataOutput(output:ByteArray):void {
			...
			for(i=0; i<size_role_rece_flowers; i++) {
				...
				var tVo_role_rece_flowers:p_role_rece_flowers_last_week_rank = this.role_rece_flowers[i] as p_role_rece_flowers_last_week_rank;
		...
		public override function readFromDataOutput(input:ByteArray):void {
			...
			if (length_role_rece_flowers > 0) {
				...
				for(i=0; i<size_role_rece_flowers; i++) {
					var tmp_role_rece_flowers:p_role_rece_flowers_last_week_rank = new p_role_rece_flowers_last_week_rank;
