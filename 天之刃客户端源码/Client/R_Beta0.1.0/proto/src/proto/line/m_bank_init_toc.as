package proto.line {
	...
	public class m_bank_init_toc extends Message
	{
		...
		public function m_bank_init_toc() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_bank_init_toc", m_bank_init_toc);
		}
