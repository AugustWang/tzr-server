package proto.line {
	...
	public class m_letter_get_send_toc extends Message
	{
		public var letters:Array = new Array;
		public var only_many_send:Boolean = false;
		public var request_mark:int = 0;
		public function m_letter_get_send_toc() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_letter_get_send_toc", m_letter_get_send_toc);
		}
