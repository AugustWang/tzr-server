package proto.line {
	...
	public class m_pet_grow_give_up_toc extends Message
	{
		public var succ:Boolean = true;
		public var reason:String = "";
		public var grow_info:p_role_pet_grow = null;
		public var info_configs:Array = new Array;
		public function m_pet_grow_give_up_toc() {
			super();
			this.grow_info = new p_role_pet_grow;

			flash.net.registerClassAlias("copy.proto.line.m_pet_grow_give_up_toc", m_pet_grow_give_up_toc);
		}
