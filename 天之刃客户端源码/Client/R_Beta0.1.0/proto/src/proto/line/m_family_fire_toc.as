package proto.line {
	...
	public class m_family_fire_toc extends Message
	{
		...
		public function m_family_fire_toc() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_family_fire_toc", m_family_fire_toc);
		}
