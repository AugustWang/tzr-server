package proto.line {
	...
	public class m_educate_fb_enter_toc extends Message
	{
		public var succ:Boolean = true;
		public var return_self:Boolean = true;
		public var reason:String = "";
		public var monster_type_ids:Array = new Array;
		public function m_educate_fb_enter_toc() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_educate_fb_enter_toc", m_educate_fb_enter_toc);
		}
