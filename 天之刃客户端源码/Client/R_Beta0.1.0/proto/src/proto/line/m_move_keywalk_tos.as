package proto.line {
	...
	public class m_move_keywalk_tos extends Message
	{
		public var pos:p_pos = null;
		public function m_move_keywalk_tos() {
			super();
			this.pos = new p_pos;

			flash.net.registerClassAlias("copy.proto.line.m_move_keywalk_tos", m_move_keywalk_tos);
		}
