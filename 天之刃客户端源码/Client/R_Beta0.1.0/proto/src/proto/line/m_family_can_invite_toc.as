package proto.line {
	...
	public class m_family_can_invite_toc extends Message
	{
		public var roles:Array = new Array;
		public function m_family_can_invite_toc() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_family_can_invite_toc", m_family_can_invite_toc);
		}
		public override function getMethodName():String {
			return 'family_can_invite';
		}
		public override function writeToDataOutput(output:ByteArray):void {
			...
			for(i=0; i<size_roles; i++) {
				...
				var tVo_roles:p_recommend_member_info = this.roles[i] as p_recommend_member_info;
		...
		public override function readFromDataOutput(input:ByteArray):void {
			...
			if (length_roles > 0) {
				...
				for(i=0; i<size_roles; i++) {
					var tmp_roles:p_recommend_member_info = new p_recommend_member_info;
