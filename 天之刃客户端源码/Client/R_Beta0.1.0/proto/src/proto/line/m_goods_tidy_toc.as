package proto.line {
	...
	public class m_goods_tidy_toc extends Message
	{
		public var bagid:int = 0;
		public var goods:Array = new Array;
		public function m_goods_tidy_toc() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_goods_tidy_toc", m_goods_tidy_toc);
		}
