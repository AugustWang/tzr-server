package proto.line {
	...
	public class m_friend_accept_toc extends Message
	{
		...
		public function m_friend_accept_toc() {
			super();
			this.friend_info = new p_friend_info;

			flash.net.registerClassAlias("copy.proto.line.m_friend_accept_toc", m_friend_accept_toc);
		}
