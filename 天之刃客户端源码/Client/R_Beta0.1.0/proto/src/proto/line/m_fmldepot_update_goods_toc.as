package proto.line {
	...
	public class m_fmldepot_update_goods_toc extends Message
	{
		public var update_type:int = 0;
		public var goods:Array = new Array;
		public function m_fmldepot_update_goods_toc() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_fmldepot_update_goods_toc", m_fmldepot_update_goods_toc);
		}
		public override function getMethodName():String {
			return 'fmldepot_update_goods';
		}
		public override function writeToDataOutput(output:ByteArray):void {
			var i:int;
			output.writeInt(this.update_type);
		...
		public override function readFromDataOutput(input:ByteArray):void {
			var i:int;
			this.update_type = input.readInt();
