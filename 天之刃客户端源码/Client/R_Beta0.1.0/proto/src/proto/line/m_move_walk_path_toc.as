package proto.line {
	...
	public class m_move_walk_path_toc extends Message
	{
		public var roleid:int = 0;
		public var walk_path:p_walk_path = null;
		public function m_move_walk_path_toc() {
			super();
			this.walk_path = new p_walk_path;

			flash.net.registerClassAlias("copy.proto.line.m_move_walk_path_toc", m_move_walk_path_toc);
		}
