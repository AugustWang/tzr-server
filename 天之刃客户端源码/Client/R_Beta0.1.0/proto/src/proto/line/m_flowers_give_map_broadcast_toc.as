package proto.line {
	...
	public class m_flowers_give_map_broadcast_toc extends Message
	{
		public var broadcast:p_flowers_give_broadcast_info = null;
		public function m_flowers_give_map_broadcast_toc() {
			super();
			this.broadcast = new p_flowers_give_broadcast_info;

			flash.net.registerClassAlias("copy.proto.line.m_flowers_give_map_broadcast_toc", m_flowers_give_map_broadcast_toc);
		}
		public override function getMethodName():String {
			return 'flowers_give_map_broadcast';
		}
