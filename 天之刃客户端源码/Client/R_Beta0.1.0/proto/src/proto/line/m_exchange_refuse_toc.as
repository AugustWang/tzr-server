package proto.line {
	...
	public class m_exchange_refuse_toc extends Message
	{
		...
		public function m_exchange_refuse_toc() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_exchange_refuse_toc", m_exchange_refuse_toc);
		}
