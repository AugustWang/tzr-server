package proto.line {
	...
	public class m_refining_inbag_list_toc extends Message
	{
		public var bagid:int = 0;
		public var goods:Array = new Array;
		public function m_refining_inbag_list_toc() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_refining_inbag_list_toc", m_refining_inbag_list_toc);
		}
