package proto.line {
	...
	public class m_refining_inlay_tos extends Message
	{
		public var bagid:int = 0;
		public var equipid:int = 0;
		public function m_refining_inlay_tos() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_refining_inlay_tos", m_refining_inlay_tos);
		}
