package proto.line {
	...
	public class m_team_leave_toc extends Message
	{
		...
		public function m_team_leave_toc() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_team_leave_toc", m_team_leave_toc);
		}
