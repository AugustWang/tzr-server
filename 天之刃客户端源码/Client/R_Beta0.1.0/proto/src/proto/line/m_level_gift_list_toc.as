package proto.line {
	...
	public class m_level_gift_list_toc extends Message
	{
		public var gift:p_level_gift_info = null;
		public function m_level_gift_list_toc() {
			super();
			this.gift = new p_level_gift_info;

			flash.net.registerClassAlias("copy.proto.line.m_level_gift_list_toc", m_level_gift_list_toc);
		}
		public override function getMethodName():String {
			return 'level_gift_list';
		}
		...
		public override function readFromDataOutput(input:ByteArray):void {
			...
			if (byte_gift_size > 0) {				this.gift = new p_level_gift_info;
