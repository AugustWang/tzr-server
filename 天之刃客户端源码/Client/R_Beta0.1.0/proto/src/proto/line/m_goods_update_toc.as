package proto.line {
	...
	public class m_goods_update_toc extends Message
	{
		public var goods:Array = new Array;
		public function m_goods_update_toc() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_goods_update_toc", m_goods_update_toc);
		}
