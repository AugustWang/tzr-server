package proto.line {
	...
	public class m_trading_shop_toc extends Message
	{
		public var succ:Boolean = true;
		public var reason:String = "";
		public var shop_goods:Array = new Array;
		public var max_buy_time:int = 0;
		public var max_sale_time:int = 0;
		public var role_goods:Array = new Array;
		public var bill:int = 0;
		public var max_bill:int = 0;
		public var update_time:int = 0;
		public function m_trading_shop_toc() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_trading_shop_toc", m_trading_shop_toc);
		}
		...
		public override function writeToDataOutput(output:ByteArray):void {
			...
			output.writeInt(this.max_buy_time);
			output.writeInt(this.max_sale_time);
			...
			output.writeInt(this.update_time);
		}
		public override function readFromDataOutput(input:ByteArray):void {
			...
			this.max_buy_time = input.readInt();
			this.max_sale_time = input.readInt();
			...
			this.update_time = input.readInt();
		}
	}
}
