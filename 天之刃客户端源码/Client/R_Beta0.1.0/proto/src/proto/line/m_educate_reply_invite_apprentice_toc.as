package proto.line {
	...
	public class m_educate_reply_invite_apprentice_toc extends Message
	{
		public var succ:Boolean = true;
		public var reason:String = "";
		public var info:p_educate_role_info = null;
		public function m_educate_reply_invite_apprentice_toc() {
			super();
			this.info = new p_educate_role_info;

			flash.net.registerClassAlias("copy.proto.line.m_educate_reply_invite_apprentice_toc", m_educate_reply_invite_apprentice_toc);
		}
