package proto.line {
	...
	public class m_educate_invite_admissions_result_toc extends Message
	{
		public var succ:Boolean = true;
		public var reason:String = "";
		public var info:p_educate_role_info = null;
		public function m_educate_invite_admissions_result_toc() {
			super();
			this.info = new p_educate_role_info;

			flash.net.registerClassAlias("copy.proto.line.m_educate_invite_admissions_result_toc", m_educate_invite_admissions_result_toc);
		}
		public override function getMethodName():String {
			return 'educate_invite_admissions_result';
		}
