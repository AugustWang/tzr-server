package proto.line {
	...
	public class m_team_kick_toc extends Message
	{
		...
		public function m_team_kick_toc() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_team_kick_toc", m_team_kick_toc);
		}
