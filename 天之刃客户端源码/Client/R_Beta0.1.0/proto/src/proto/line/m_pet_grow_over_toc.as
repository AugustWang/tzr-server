package proto.line {
	...
	public class m_pet_grow_over_toc extends Message
	{
		public var grow_type:int = 0;
		public var grow_info:p_role_pet_grow = null;
		public var info_configs:Array = new Array;
		public function m_pet_grow_over_toc() {
			super();
			this.grow_info = new p_role_pet_grow;

			flash.net.registerClassAlias("copy.proto.line.m_pet_grow_over_toc", m_pet_grow_over_toc);
		}
		public override function getMethodName():String {
			return 'pet_grow_over';
		}
