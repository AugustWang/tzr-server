package proto.line {
	...
	public class m_equip_build_signature_toc extends Message
	{
		public var succ:Boolean = true;
		public var reason:String = "";
		public var equip:p_goods = null;
		public function m_equip_build_signature_toc() {
			super();
			this.equip = new p_goods;

			flash.net.registerClassAlias("copy.proto.line.m_equip_build_signature_toc", m_equip_build_signature_toc);
		}
