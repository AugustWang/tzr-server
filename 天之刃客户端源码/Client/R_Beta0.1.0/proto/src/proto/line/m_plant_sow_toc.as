package proto.line {
	...
	public class m_plant_sow_toc extends Message
	{
		public var succ:Boolean = true;
		public var reason:String = "";
		public var farm_info:p_map_farm = null;
		public var remain_fertilize_times:int = 0;
		public function m_plant_sow_toc() {
			super();
			this.farm_info = new p_map_farm;

			flash.net.registerClassAlias("copy.proto.line.m_plant_sow_toc", m_plant_sow_toc);
		}
