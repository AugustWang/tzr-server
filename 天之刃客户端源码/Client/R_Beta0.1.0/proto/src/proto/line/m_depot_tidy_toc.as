package proto.line {
	...
	public class m_depot_tidy_toc extends Message
	{
		public var succ:Boolean = true;
		public var bagid:int = 0;
		public var goods_list:Array = new Array;
		public function m_depot_tidy_toc() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_depot_tidy_toc", m_depot_tidy_toc);
		}
