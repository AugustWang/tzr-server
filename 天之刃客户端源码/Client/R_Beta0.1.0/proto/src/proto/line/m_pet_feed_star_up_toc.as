package proto.line {
	...
	public class m_pet_feed_star_up_toc extends Message
	{
		public var succ:Boolean = true;
		public var succ2:Boolean = true;
		public var reason:String = "";
		public var info:p_pet_feed = null;
		public function m_pet_feed_star_up_toc() {
			super();
			this.info = new p_pet_feed;

			flash.net.registerClassAlias("copy.proto.line.m_pet_feed_star_up_toc", m_pet_feed_star_up_toc);
		}
