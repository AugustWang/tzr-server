package proto.line {
	...
	public class m_pet_change_pos_toc extends Message
	{
		public var succ:Boolean = true;
		public var reason:String = "";
		public var info:p_role_pet_bag = null;
		public function m_pet_change_pos_toc() {
			super();
			this.info = new p_role_pet_bag;

			flash.net.registerClassAlias("copy.proto.line.m_pet_change_pos_toc", m_pet_change_pos_toc);
		}
		public override function getMethodName():String {
			return 'pet_change_pos';
		}
