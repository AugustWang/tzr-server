package proto.line {
	...
	public class m_team_refuse_tos extends Message
	{
		public var role_id:int = 0;
		public var team_id:int = 0;
		public var leader_id:int = 0;
		public var type_id:int = 0;
		public function m_team_refuse_tos() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_team_refuse_tos", m_team_refuse_tos);
		}
