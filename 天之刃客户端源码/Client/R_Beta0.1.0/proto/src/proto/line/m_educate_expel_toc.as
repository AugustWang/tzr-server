package proto.line {
	...
	public class m_educate_expel_toc extends Message
	{
		...
		public function m_educate_expel_toc() {
			super();
			this.info = new p_educate_role_info;

			flash.net.registerClassAlias("copy.proto.line.m_educate_expel_toc", m_educate_expel_toc);
		}
