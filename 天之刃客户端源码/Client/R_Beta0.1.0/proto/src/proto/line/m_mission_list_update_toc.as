package proto.line {
	...
	public class m_mission_list_update_toc extends Message
	{
		public var missions:Array = new Array;
		public function m_mission_list_update_toc() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_mission_list_update_toc", m_mission_list_update_toc);
		}
		public override function getMethodName():String {
			return 'mission_list_update';
		}
