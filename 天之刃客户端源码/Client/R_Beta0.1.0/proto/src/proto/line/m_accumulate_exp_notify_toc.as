package proto.line {
	...
	public class m_accumulate_exp_notify_toc extends Message
	{
		public var list:Array = new Array;
		public function m_accumulate_exp_notify_toc() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_accumulate_exp_notify_toc", m_accumulate_exp_notify_toc);
		}
		public override function getMethodName():String {
			return 'accumulate_exp_notify';
		}
