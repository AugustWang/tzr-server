package proto.line {
	...
	public class m_refining_divide_toc extends Message
	{
		public var succ:Boolean = true;
		public var reason:String = "";
		public var goods1:p_goods = null;
		public var goods2:p_goods = null;
		public function m_refining_divide_toc() {
			super();
			this.goods1 = new p_goods;
			this.goods2 = new p_goods;

			flash.net.registerClassAlias("copy.proto.line.m_refining_divide_toc", m_refining_divide_toc);
		}
