package proto.line {
	...
	public class m_flowers_get_accept_list_toc extends Message
	{
		public var list:Array = new Array;
		public function m_flowers_get_accept_list_toc() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_flowers_get_accept_list_toc", m_flowers_get_accept_list_toc);
		}
		...
		public override function writeToDataOutput(output:ByteArray):void {
			...
			for(i=0; i<size_list; i++) {
				...
				var tVo_list:p_flowers_give_info = this.list[i] as p_flowers_give_info;
		...
		public override function readFromDataOutput(input:ByteArray):void {
			...
			if (length_list > 0) {
				...
				for(i=0; i<size_list; i++) {
					var tmp_list:p_flowers_give_info = new p_flowers_give_info;
