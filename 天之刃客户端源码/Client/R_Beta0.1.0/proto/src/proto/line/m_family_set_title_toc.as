package proto.line {
	...
	public class m_family_set_title_toc extends Message
	{
		...
		public function m_family_set_title_toc() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_family_set_title_toc", m_family_set_title_toc);
		}
