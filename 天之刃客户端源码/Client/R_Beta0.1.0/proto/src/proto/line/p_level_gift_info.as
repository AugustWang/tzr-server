package proto.line {
	...
	public class p_level_gift_info extends Message
	{
		public var id:int = 0;
		public var goods_list:Array = new Array;
		public var next_level:int = 0;
		public function p_level_gift_info() {
			super();

			flash.net.registerClassAlias("copy.proto.line.p_level_gift_info", p_level_gift_info);
		}
		...
		public override function writeToDataOutput(output:ByteArray):void {
			...
			output.writeInt(this.next_level);
		}
