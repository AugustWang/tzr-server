package proto.line {
	...
	public class m_educate_filter_student_toc extends Message
	{
		public var roles:Array = new Array;
		public function m_educate_filter_student_toc() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_educate_filter_student_toc", m_educate_filter_student_toc);
		}
