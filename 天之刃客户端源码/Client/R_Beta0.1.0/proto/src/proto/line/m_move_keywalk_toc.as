package proto.line {
	...
	public class m_move_keywalk_toc extends Message
	{
		public var role_id:int = 0;
		public var pos:p_pos = null;
		public function m_move_keywalk_toc() {
			super();
			this.pos = new p_pos;

			flash.net.registerClassAlias("copy.proto.line.m_move_keywalk_toc", m_move_keywalk_toc);
		}
