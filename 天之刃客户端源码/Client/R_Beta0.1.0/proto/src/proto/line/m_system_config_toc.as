package proto.line {
	...
	public class m_system_config_toc extends Message
	{
		public var sys_config:p_sys_config = null;
		public function m_system_config_toc() {
			super();
			this.sys_config = new p_sys_config;

			flash.net.registerClassAlias("copy.proto.line.m_system_config_toc", m_system_config_toc);
		}
