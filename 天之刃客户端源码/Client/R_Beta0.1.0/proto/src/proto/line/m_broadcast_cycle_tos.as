package proto.line {
	...
	public class m_broadcast_cycle_tos extends Message
	{
		public var type:int = 0;
		public var sub_type:int = 0;
		public var content:String = "";
		public var send_type:int = 0;
		...
		public function m_broadcast_cycle_tos() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_broadcast_cycle_tos", m_broadcast_cycle_tos);
		}
		...
		public override function writeToDataOutput(output:ByteArray):void {
			...
			output.writeInt(this.send_type);
