package proto.line {
	...
	public class m_move_keystop_tos extends Message
	{
		public var pos:p_pos = null;
		public function m_move_keystop_tos() {
			super();
			this.pos = new p_pos;

			flash.net.registerClassAlias("copy.proto.line.m_move_keystop_tos", m_move_keystop_tos);
		}
