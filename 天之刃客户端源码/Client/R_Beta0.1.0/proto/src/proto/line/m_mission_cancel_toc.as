package proto.line {
	...
	public class m_mission_cancel_toc extends Message
	{
		public var id:int = 0;
		...
		public function m_mission_cancel_toc() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_mission_cancel_toc", m_mission_cancel_toc);
		}
