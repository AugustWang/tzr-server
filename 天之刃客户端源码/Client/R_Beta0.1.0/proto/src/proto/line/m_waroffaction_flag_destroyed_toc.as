package proto.line {
	...
	public class m_waroffaction_flag_destroyed_toc extends Message
	{
		public var attack_faction_id:int = 0;
		public var defence_faction_id:int = 0;
		public var attack_role_name:String = "";
		public function m_waroffaction_flag_destroyed_toc() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_waroffaction_flag_destroyed_toc", m_waroffaction_flag_destroyed_toc);
		}
		public override function getMethodName():String {
			return 'waroffaction_flag_destroyed';
		}
