package proto.line {
	...
	public class m_broadcast_countdown_tos extends Message
	{
		...
		public function m_broadcast_countdown_tos() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_broadcast_countdown_tos", m_broadcast_countdown_tos);
		}
