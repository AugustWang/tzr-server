package proto.line {
	...
	public class m_bank_sell_toc extends Message
	{
		...
		public function m_bank_sell_toc() {
			super();
			this.sheet = new p_bank_sheet;

			flash.net.registerClassAlias("copy.proto.line.m_bank_sell_toc", m_bank_sell_toc);
		}
