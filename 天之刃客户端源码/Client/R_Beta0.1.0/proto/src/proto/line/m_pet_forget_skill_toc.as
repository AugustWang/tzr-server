package proto.line {
	...
	public class m_pet_forget_skill_toc extends Message
	{
		public var succ:Boolean = true;
		public var reason:String = "";
		public var pet_info:p_pet = null;
		public function m_pet_forget_skill_toc() {
			super();
			this.pet_info = new p_pet;

			flash.net.registerClassAlias("copy.proto.line.m_pet_forget_skill_toc", m_pet_forget_skill_toc);
		}
		public override function getMethodName():String {
			return 'pet_forget_skill';
		}
