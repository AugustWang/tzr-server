package proto.line {
	...
	public class m_educate_release_toc extends Message
	{
		public var succ:Boolean = true;
		public var info:p_educate_role_info = null;
		public var reason:String = "";
		public function m_educate_release_toc() {
			super();
			this.info = new p_educate_role_info;

			flash.net.registerClassAlias("copy.proto.line.m_educate_release_toc", m_educate_release_toc);
		}
