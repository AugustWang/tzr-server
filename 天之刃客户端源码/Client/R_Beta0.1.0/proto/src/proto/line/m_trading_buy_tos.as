package proto.line {
	...
	public class m_trading_buy_tos extends Message
	{
		public var npc_id:int = 0;
		public var map_id:int = 0;
		public var type_id:int = 0;
		public var number:int = 0;
		public function m_trading_buy_tos() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_trading_buy_tos", m_trading_buy_tos);
		}
