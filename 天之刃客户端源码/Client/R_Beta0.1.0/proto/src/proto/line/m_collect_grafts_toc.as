package proto.line {
	...
	public class m_collect_grafts_toc extends Message
	{
		public var succ:Boolean = true;
		public var goods_list:Array = new Array;
		public var reason:String = "";
		public function m_collect_grafts_toc() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_collect_grafts_toc", m_collect_grafts_toc);
		}
