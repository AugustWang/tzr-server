package proto.line {
	...
	public class m_office_refuse_appoint_toc extends Message
	{
		...
		public function m_office_refuse_appoint_toc() {
			super();

			flash.net.registerClassAlias("copy.proto.line.m_office_refuse_appoint_toc", m_office_refuse_appoint_toc);
		}
