package proto.common {
	...
	public class p_family_gongxun_rank extends Message
	{
		...
		public var lastweek_gongxun:int = 0;
		public var lastweek_ranking:int = 0;
		public function p_family_gongxun_rank() {
			super();

			flash.net.registerClassAlias("copy.proto.common.p_family_gongxun_rank", p_family_gongxun_rank);
		}
		public override function getMethodName():String {
			return 'family_gongxun_';
		}
		public override function writeToDataOutput(output:ByteArray):void {
			...
			output.writeInt(this.lastweek_gongxun);
			output.writeInt(this.lastweek_ranking);
		}
		public override function readFromDataOutput(input:ByteArray):void {
			...
			this.lastweek_gongxun = input.readInt();
			this.lastweek_ranking = input.readInt();
		}
	}
}
