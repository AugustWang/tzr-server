package proto.common {
	...
	public class s_chat_join_channel_tos extends Message
	{
		public var channel_info:p_channel_info = null;
		public var role_info:p_chat_role = null;
		public function s_chat_join_channel_tos() {
			super();
			this.channel_info = new p_channel_info;
			this.role_info = new p_chat_role;

			flash.net.registerClassAlias("copy.proto.common.s_chat_join_channel_tos", s_chat_join_channel_tos);
		}
