package proto.common {
	...
	public class p_role_give_flowers_last_week_rank extends Message
	{
		...
		public function p_role_give_flowers_last_week_rank() {
			super();

			flash.net.registerClassAlias("copy.proto.common.p_role_give_flowers_last_week_rank", p_role_give_flowers_last_week_rank);
		}
		public override function getMethodName():String {
			return 'role_give_flowers_last_week_';
		}
