package proto.login {
	...
	public class m_login_flash_toc extends Message
	{
		public var succ:Boolean = true;
		public var reason:String = "";
		public var result:Array = new Array;
		public var faction_id:int = 1;
		public function m_login_flash_toc() {
			super();

			flash.net.registerClassAlias("copy.proto.login.m_login_flash_toc", m_login_flash_toc);
		}
