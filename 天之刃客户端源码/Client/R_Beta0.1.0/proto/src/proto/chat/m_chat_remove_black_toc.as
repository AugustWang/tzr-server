package proto.chat {
	...
	public class m_chat_remove_black_toc extends Message
	{
		public var succ:Boolean = true;
		public var reason:String = "";
		public var role_info:p_chat_role = null;
		public function m_chat_remove_black_toc() {
			super();
			this.role_info = new p_chat_role;

			flash.net.registerClassAlias("copy.proto.chat.m_chat_remove_black_toc", m_chat_remove_black_toc);
		}
