package modules.greenHand.view
{
	...
	public class GreenHandWindow extends BasePanel
	{
		public function GreenHandWindow(key:String=null)
		{
			super("GreenHandWindow");
		...
		override protected function init():void{
			...
			descTxt = ComponentUtil.createTextField("                 使用激活码，可以领取相应的奖励!",20,5,null,350,40,this);
