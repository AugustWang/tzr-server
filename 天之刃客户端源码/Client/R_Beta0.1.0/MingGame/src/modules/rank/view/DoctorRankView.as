package modules.rank.view
{
	...
	public class DoctorRankView extends Sprite
	{
		private var levelGrid:DataGrid;
		private var skin:Skin = new Skin();
		public function DoctorRankView()
		{
			super();
		...
		public function changeData(DoctorArr:Array):void{
			
			if(DoctorArr.length+1<11){
				levelGrid.pageCount = DoctorArr.length + 1;
			}else {
				levelGrid.pageCount = 11;
			}
			levelGrid.dataProvider = DoctorArr;
