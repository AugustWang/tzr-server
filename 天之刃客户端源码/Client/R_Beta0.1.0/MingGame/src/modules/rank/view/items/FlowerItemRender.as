package modules.rank.view.items
{
	...
	import proto.common.p_role_rece_flowers_last_week_rank;
	import proto.common.p_role_rece_flowers_rank;
	import proto.common.p_role_rece_flowers_today_rank;
	import proto.common.p_role_rece_flowers_yesterday_rank;
	
	public class FlowerItemRender extends UIComponent
	{
		private var rankTxt:TextField;
		private var playTxt:TextField;
		private var charmTxt:TextField;
		private var familyTxt:TextField;
		private var stateTxt:TextField;
		private var titleTxt:TextField;
		public function FlowerItemRender()
		{
			this.width = 439;
			this.height = 25;
			...
			charmTxt = ComponentUtil.createTextField("",playTxt.x + playTxt.width,playTxt.y,textFormat,60,25,this);
			familyTxt = ComponentUtil.createTextField("",charmTxt.x + charmTxt.width,charmTxt.y,textFormat,92,25,this);
		...
		//赋值
		private function setValue(rank:int,player:String,charm:String,family:String,state:String,title:String):void{
		...
		override public function set data(value:Object):void{
			super.data = value;
			if(value is p_role_rece_flowers_rank){
				var vo1:p_role_rece_flowers_rank = value as p_role_rece_flowers_rank;
				setValue(vo1.ranking,vo1.role_name,vo1.charm.toString(),vo1.family_name,GameConstant.getNation(vo1.faction_id),vo1.title);
			}else if(value is p_role_rece_flowers_yesterday_rank){
				var vo2:p_role_rece_flowers_yesterday_rank = value as p_role_rece_flowers_yesterday_rank;
				setValue(vo2.ranking,vo2.role_name,vo2.charm.toString(),vo2.family_name,GameConstant.getNation(vo2.faction_id),vo2.title);
			}else if(value is p_role_rece_flowers_today_rank){
				var vo3:p_role_rece_flowers_today_rank = value as p_role_rece_flowers_today_rank;
				setValue(vo3.ranking,vo3.role_name,vo3.charm.toString(),vo3.family_name,GameConstant.getNation(vo3.faction_id),vo3.title);
			}else if(value is p_role_rece_flowers_last_week_rank){
				var vo4:p_role_rece_flowers_last_week_rank = value as p_role_rece_flowers_last_week_rank;
				setValue(vo4.ranking,vo4.role_name,vo4.charm.toString(),vo4.family_name,GameConstant.getNation(vo4.faction_id),vo4.title);
			}
			
			if(GlobalObjectManager.getInstance().user.base.role_id == value.role_id){
				rankTxt.textColor = 0xffcc00;
				playTxt.textColor = 0xffcc00;
				charmTxt.textColor = 0xffcc00;
