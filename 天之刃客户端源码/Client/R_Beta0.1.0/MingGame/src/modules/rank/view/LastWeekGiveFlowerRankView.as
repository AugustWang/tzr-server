package modules.rank.view
{
	...
	public class LastWeekGiveFlowerRankView extends Sprite
	{
		private var levelGrid:DataGrid;
		private var skin:Skin = new Skin();
		public function LastWeekGiveFlowerRankView()
		{
			super();
		...
		public function changeData(lastWeekGiveArr:Array):void{
			
			if(lastWeekGiveArr.length+1<11){
				levelGrid.pageCount = lastWeekGiveArr.length + 1;
			}else {
				levelGrid.pageCount = 11;
			}
			levelGrid.dataProvider = lastWeekGiveArr;
			levelGrid.invalidateDisplayList();
		}
	}
}