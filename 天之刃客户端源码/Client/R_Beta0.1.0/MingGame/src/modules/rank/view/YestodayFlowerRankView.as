package modules.rank.view
{
	...
	public class YestodayFlowerRankView extends Sprite
	{
		private var levelGrid:DataGrid;
		private var skin:Skin = new Skin();
		public function YestodayFlowerRankView()
		{
			super();
		...
		public function changeData(yestodayFlowerArr:Array):void{
			
			if(yestodayFlowerArr.length+1<11){
				levelGrid.pageCount = yestodayFlowerArr.length + 1;
			}else {
				levelGrid.pageCount = 11;
			}
			levelGrid.dataProvider = yestodayFlowerArr;
