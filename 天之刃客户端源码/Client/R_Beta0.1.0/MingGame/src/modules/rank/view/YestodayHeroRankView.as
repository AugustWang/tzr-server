package modules.rank.view
{
	...
	public class YestodayHeroRankView extends Sprite
	{
		private var heroGrid:DataGrid;
		private var skin:Skin = new Skin();
		public function YestodayHeroRankView()
		{
		...
		public function changeData(yestodayHeroArr:Array):void{
			
			if(yestodayHeroArr.length+1<11){
				heroGrid.pageCount = yestodayHeroArr.length + 1;
			}else {
				heroGrid.pageCount = 11;
			}
			heroGrid.dataProvider = yestodayHeroArr;
			heroGrid.invalidateDisplayList();
		}
	}
}