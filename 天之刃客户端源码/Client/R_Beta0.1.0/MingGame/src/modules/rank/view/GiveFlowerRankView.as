package modules.rank.view
{
	...
	public class GiveFlowerRankView extends Sprite
	{
		private var levelGrid:DataGrid;
		private var skin:Skin = new Skin();
		public function GiveFlowerRankView()
		{
			super();
		...
		public function changeData(giveArr:Array):void{
			
			if(giveArr.length+1<11){
				levelGrid.pageCount = giveArr.length + 1;
			}else {
				levelGrid.pageCount = 11;
			}
			levelGrid.dataProvider = giveArr;
