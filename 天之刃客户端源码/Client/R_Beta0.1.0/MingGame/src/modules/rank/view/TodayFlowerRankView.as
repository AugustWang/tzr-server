package modules.rank.view
{
	...
	public class TodayFlowerRankView extends Sprite
	{
		private var levelGrid:DataGrid;
		private var skin:Skin = new Skin();
		public function TodayFlowerRankView()
		{
			super();
		...
		public function changeData(todayFlowerArr:Array):void{
			
			if(todayFlowerArr.length+1<11){
				levelGrid.pageCount = todayFlowerArr.length + 1;
			}else {
				levelGrid.pageCount = 11;
			}
			levelGrid.dataProvider = todayFlowerArr;
			levelGrid.invalidateDisplayList();
		}
	}
}