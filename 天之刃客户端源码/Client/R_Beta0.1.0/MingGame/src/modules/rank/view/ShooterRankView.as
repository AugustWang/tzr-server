package modules.rank.view
{
	...
	public class ShooterRankView extends Sprite
	{
		private var levelGrid:DataGrid;
		private var skin:Skin = new Skin();
		public function ShooterRankView()
		{
			super();
		...
		public function changeData(shooterArr:Array):void{
			
			if(shooterArr.length+1<11){
				levelGrid.pageCount = shooterArr.length + 1;
			}else {
				levelGrid.pageCount = 11;
			}
			levelGrid.dataProvider = shooterArr;
