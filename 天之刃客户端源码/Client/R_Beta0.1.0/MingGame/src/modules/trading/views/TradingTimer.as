package modules.trading.views
{
	...
	public class TradingTimer extends UIComponent
	{
		public var totalTime:int = 3600;
		private var text:TextField;
		private var timer:Timer;
		
		public function TradingTimer()
		{
			super();
			width = 100;
			height = 40;
			...
			var bg:Bitmap = Style.getBitmap(GameConfig.T1_VIEWUI,"timerBg");
			this.addChild(bg);
			bg.width = 100;
			bg.height = 40;
			var tf:TextFormat = new TextFormat("Tahoma",12,0xFFF673);
			tf.align = "center";
			text = ComponentUtil.createTextField("商贸",5,3,tf,95,40,this);
			text.wordWrap = true;
			text.multiline = true;
