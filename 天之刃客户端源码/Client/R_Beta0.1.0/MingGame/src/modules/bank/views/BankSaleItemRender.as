package modules.bank.views
{
	...
	public class BankSaleItemRender extends UIComponent implements IDataRenderer
	{
		/**
		 * 下面的 listItem 
		 * 
		 */		
		public function BankSaleItemRender()
		{
			setupUI();
//			Style.getInstance().p
		}
		...
		{
			var textFormat:TextFormat = new TextFormat("Tahoma",12,0xece8bb,false,null,null,null,null,"center");
			_idTF = BankConstant.createTextField("出售价1",0,0,65,22,textFormat,this);//new TextFormat(null,12,0xAF6758,true)
			...
			_operatingBtn.width = 60;//66;
			_operatingBtn.x = 186;//188;
			_operatingBtn.y = -3;
			_operatingBtn.textFormat(new TextFormat(null,12,0xcde644));
			_operatingBtn.label = "<u>撤单</u>";//撤销
		...
		{
			if(value.operate == "<U>出售元宝</U>")
				_operatingBtn.textFormat(new TextFormat(null,12,0xfec401));
			_data = value;
