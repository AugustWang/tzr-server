package modules.bank.views
{
	...
	public class BankItRender extends UIComponent implements IDataRenderer
	{
		private var _perYBTF:TextField;
		private var _YBNumTF:TextField;
		private var _operatingBtn:LinkButton;
		
		public function BankItRender()
		{
			super();
			setupUI();
		}
		...
		private function setupUI():void
		{
			...
			_perYBTF = BankConstant.createTextField("1锭30两",0,0,88,22,textFormat,this);
			_YBNumTF = BankConstant.createTextField("50",86,0,88,22,textFormat,this);
			_operatingBtn = new LinkButton();
			_operatingBtn.buttonMode = true;
			_operatingBtn.useHandCursor = true;
			_operatingBtn.width = 74;//96;
			_operatingBtn.x = 172;// 
			_operatingBtn.y = -3;
			_operatingBtn.textFormat(new TextFormat(null,12,0xcde644,null,null,null,null,null,"center"));//0xDEC38C
			_operatingBtn.label = "<u>买入</u>";  // 买入  卖出
