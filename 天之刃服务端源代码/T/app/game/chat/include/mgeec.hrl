...
-record(chat_role_state, {gateway_pid, channel_list, role_id, role_name, process_name, role_base, role_attr, role_ext, chat_role_info, client_ip, last_chat_time={0, 0, 0}}).

-define(CHAT_TIME_LIMIE, 0).%%前后发言时间限制

-record(chat_log_data, {to_type, to_sign, role_id, rolename,  msg, time}).
-define(LOG_FILE_BASE_DIR, "/data/logs/chat.logs/").
