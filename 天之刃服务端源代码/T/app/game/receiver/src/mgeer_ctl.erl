...
-spec init() -> 'ok'.
init() ->
    ets:new(mgeer_ctl_cmds, [named_table, set, public]),
    ets:new(mgeer_ctl_host_cmds, [named_table, set, public]),
    ok.
...
process(["status"]) ->
    ...
    case lists:keysearch(mgeer, 1, application:which_applications()) of
        false ->
