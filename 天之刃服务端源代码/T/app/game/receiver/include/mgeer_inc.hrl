%%%-------------------------------------------------------------------
%%% @author QingliangCn <>
%%% Created : 30 Jun 2010 by QingliangCn <>
%%%-------------------------------------------------------------------


-define(DEBUG(Format, Args),
    mgeer_logger:debug_msg(?MODULE,?LINE,Format, Args)).

-define(INFO_MSG(Format, Args),
    mgeer_logger:info_msg(?MODULE,?LINE,Format, Args)).
			      
-define(WARNING_MSG(Format, Args),
    mgeer_logger:warning_msg(?MODULE,?LINE,Format, Args)).
			      
-define(ERROR_MSG(Format, Args),
    mgeer_logger:error_msg(?MODULE,?LINE,Format, Args)).

-define(CRITICAL_MSG(Format, Args),
    mgeer_logger:critical_msg(?MODULE,?LINE,Format, Args)).
