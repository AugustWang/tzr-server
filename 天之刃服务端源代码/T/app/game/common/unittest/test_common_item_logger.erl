...
t_clog()->
    ...
    R31 = Record#r_item_log{action=?LOG_ITEM_TYPE_XI_TONG_ZENG_SONG,item_id=30,amount=1},
    R32 = Record#r_item_log{action=?LOG_ITEM_TYPE_XI_TONG_ZENG_SONG,item_id=30,amount=1},
    R33 = Record#r_item_log{action=?LOG_ITEM_TYPE_XI_TONG_ZENG_SONG,item_id=30,amount=1},
