...
change3(RoleMapInfo, SRoleMapInfo) ->
    #p_map_role{pk_point=PKPoint, gray_name=GrayName, faction_id=FactionID, pos=Pos} = RoleMapInfo,
    #p_map_role{role_id=SRoleID, pk_point=SPKPoint, faction_id=SFactionID} = SRoleMapInfo,
