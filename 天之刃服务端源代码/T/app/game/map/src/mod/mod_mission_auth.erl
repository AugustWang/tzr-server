...
auth_show(RoleID, MissionBaseInfo) -> 
    ...
    case i_auth_take(RoleID, MissionBaseInfo) of
...
i_auth_take_0(RoleID, MissionBaseInfo) ->
    ...
    #mission_base_info{gender=Gender,faction=Faction,team=HasTeam,family=HasFamily} = MissionBaseInfo,
