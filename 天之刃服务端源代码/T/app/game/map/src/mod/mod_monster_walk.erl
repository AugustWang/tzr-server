...
monster_walk_pos(WalkPos, MonsterID, OffsetX, OffsetY, Speed, _DestPos, MonsterState) ->
    ...
    NewMonsterInfo = MonsterMapInfo#p_map_monster{move_speed = MoveSpeed+?MIN_MONSTER_WORK_TICK},
    DataRecord = #m_monster_walk_toc{monsterinfo = NewMonsterInfo, pos = #p_pos{tx=TX,ty=TY,dir=DIR}},
