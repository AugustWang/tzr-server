...
get_war_map_name(DefenceFactionID) when DefenceFactionID > 0 andalso DefenceFactionID < 4 ->
    case DefenceFactionID of
        1 ->
            PinJiangMapName = common_misc:get_map_name(11102),
            JingChengMapName = common_misc:get_map_name(11100);
        2 ->
            PinJiangMapName = common_misc:get_map_name(12102),
            JingChengMapName = common_misc:get_map_name(12100);
        3 ->
            PinJiangMapName = common_misc:get_map_name(13102),
            JingChengMapName = common_misc:get_map_name(13100)     
    end,
