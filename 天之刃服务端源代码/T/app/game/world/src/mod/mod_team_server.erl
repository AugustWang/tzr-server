        ...
        {ok, _TeamPid} ->
            ...
            case MemberTeamInfo of
                undefined ->
                    ignore;
                _ ->
                    case DataRecord#m_team_accept_tos.type_id > 0 of
                        true ->
                            common_misc:send_to_rolemap(RoleId, {mod_educate, {set_can_jump, RoleId}}),
                            common_misc:send_to_rolemap(DataRecord#m_team_accept_tos.role_id, 
                                                        {mod_educate, {set_can_jump, DataRecord#m_team_accept_tos.role_id}});
                        false ->
                            ignore
                    end
            end,
