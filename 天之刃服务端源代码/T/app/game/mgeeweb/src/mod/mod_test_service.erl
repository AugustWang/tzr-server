...
%%%
%%% @end
%%% Created : 11 Mar 2011 by QingliangCn <>
%%%-------------------------------------------------------------------
...
do_goal(Req) ->
    ...
    case db:dirty_match_object(?DB_ROLE_BASE, #p_role_base{account_name=AccountName, _='_'}) of
        ...
        [#p_role_base{role_name=RoleName}] ->
            ...
            common_misc:send_to_rolemap(RoleID, {mod_goal, {set_role_days, RoleID, Days}}),
...
do_accumulate_exp(Req) ->
    ...
    case db:dirty_match_object(?DB_ROLE_BASE, #p_role_base{account_name=AccountName, _='_'}) of
        ...
        [#p_role_base{role_name=RoleName}] ->
            RoleID = common_misc:get_roleid(RoleName),
            common_misc:send_to_rolemap(RoleID, {mod_accumulate_exp, {set_role_acc, RoleID, ID, Days, {Year, Month, Day}}}),
            mgeeweb_tool:return_json_ok(Req)
    end.
