...
<form method="get" action="">
 ...
 <a href="<{$URL_SELF}>?acname=<{$search_keyword1|escape:"url"}>&amp;nickname=<{$search_keyword2|escape:"url"}>&amp;sort_1=<{$search_sort_1}>&amp;sort_2=<{$search_sort_2}>&amp;date1=<{$date1}>&amp;date2=<{$date2}>&amp;item_id=<{$item_id}>&amp;page=<{$item}>"><{$key}></a><span style="width:5px;"></span>
 <{/foreach}>
<{if $page_count > 0}>
...
<table cellspacing="1" class='DataGrid' id = "loglist" >
<!-- SECTION  START -------------------------->
