...
<body>
	...
	<table class="SumDataGrid" width="400">
        <tr bgcolor="#E5F9FF"> 
        	<td align="center" background="/admin/static/images/wbg.gif"><font color="#666600"><b>◆开启国探</b></font></td>
        </tr>
        <tr align="center"> 
       		 <td>
    ...
    <script language="javascript">
		function chkStart(){
			...
			return confirm('你将于'+strTime+'开启<{$AGENT_NAME}> <{$SERVER_NAME}>服【' +factionName+ '】的国探，确定要开启吗？');
		}
    </script>
</body>
</html>
